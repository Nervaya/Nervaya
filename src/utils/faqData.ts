...
export const faqData: FAQItem[] = [
  {
    ...
    answer:
      "Sleep difficulties often stem from multiple factors including stress, anxiety, irregular sleep schedules, or underlying health conditions. Your mind may be racing with thoughts, or your body's natural circadian rhythm might be disrupted. Deep Rest Sessions are specifically designed to calm your mind and help your body transition into sleep naturally, even when you feel exhausted but can't fall asleep.",
  },
  {
    id: 2,
    question: 'How long does it take to see results?',
    answer:
      'Many users begin to notice improvements in their sleep quality within the first few sessions. However, individual results may vary based on your specific sleep challenges and consistency with the program. Most people see significant improvements within 2-4 weeks of regular use.',
  },
  {
    id: 3,
    question: 'What really helps you sleep better?',
    answer:
      'Better sleep comes from a combination of factors including establishing a consistent sleep schedule, creating a relaxing bedtime routine, managing stress and anxiety, and using evidence-based techniques like those in our Deep Rest Sessions. Our program combines these elements to help you achieve restful sleep.',
  },
  {
    id: 4,
    question: "What's the bottom-line cause for sleep issues?",
    answer:
      'Sleep issues can have various root causes including stress, anxiety, medical conditions, lifestyle factors, or disruptions to your circadian rhythm. Our Deep Rest Sessions address these underlying factors by helping you relax, manage stress, and establish healthy sleep patterns.',
  },
  {
    id: 5,
